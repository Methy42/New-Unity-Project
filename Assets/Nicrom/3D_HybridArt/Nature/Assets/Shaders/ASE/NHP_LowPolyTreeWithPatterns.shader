...
Shader "Nicrom/NHP/ASE/Low Poly Tree With Patterns"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 worldToObj35_g92 = mul( unity_WorldToObject, float4( appendResult14_g92, 1 ) ).xyz;
			float3 worldToObj36_g92 = mul( unity_WorldToObject, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 objToWorld52_g91 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float MB_RotationAngle97 = radians( ( ( ( ( MB_Amplitude880 + ( MB_AmplitudeOffset1356 * (StaticWorldNoise31_g91).x ) ) * sin( ( ( ( objToWorld52_g91.x + objToWorld52_g91.z ) + ( ( _Time.y * ( MB_Frequency873 + ( MB_FrequencyOffset1483 * (StaticWorldNoise31_g91).x ) ) ) + ( ( 2.0 * UNITY_PI ) * 0.0 ) ) ) * MB_Phase1360 ) ) ) + MB_DefaultBending877 ) * ( ase_vertex3Pos.y / MB_MaxHeight1335 ) ) );
			float RotationAngle54_g93 = MB_RotationAngle97;
			float3 PivotPoint60_g93 = float3( 0,0,0 );
			float3 break62_g93 = PivotPoint60_g93;
			float3 appendResult45_g93 = (float3(break62_g93.x , ase_vertex3Pos.y , break62_g93.z));
			float3 rotatedValue30_g93 = RotateAroundAxis( appendResult45_g93, ase_vertex3Pos, RotationAxis56_g93, RotationAngle54_g93 );
			...
			float3 objToWorld59_g89 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 rotatedValue29_g89 = RotateAroundAxis( PivotPosOnYAxis56_g89, ase_vertex3Pos, DB_RotationAxis757, radians( ( ( ( DB_VerticalAmplitude887 + ( DB_VerticalAmplitudeOffset1423 * ( 1.0 - PhaseShift48_g89 ) ) ) * sin( ( ( ( _Time.y * Fequency45_g89 ) - ( ( 2.0 * UNITY_PI ) * PhaseShift48_g89 ) ) + ( ( ( objToWorld59_g89.x + objToWorld59_g89.z ) + ( _Time.y * Fequency45_g89 ) ) * DB_VerticalPhase1384 ) ) ) ) * ( distance( ase_vertex3Pos , PivotPosOnYAxis56_g89 ) / DB_VerticalMaxLength1388 ) ) ) );
			float DetailBendingMask1499 = step( 1.5 , v.texcoord.xy.x );
			float3 DB_VerticalBending1314 = ( ( rotatedValue29_g89 - ase_vertex3Pos ) * DetailBendingMask1499 );
			...
			float3 objToWorld53_g88 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 LocalVertexOffset1045 = ( ( rotatedValue34_g93 - ase_vertex3Pos ) * step( 0.01 , ase_vertex3Pos.y ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;1496;-5535.044,4297.787;Inherit;False;Constant;_Float1;Float 1;26;0;Create;True;0;0;0;False;0;False;1.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;989;-5604.563,4069.742;Float;False;Property;_UnitScale;Unit Scale;30;0;Create;True;0;0;0;False;0;False;20;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1308;-5383.727,3330.877;Float;False;Property;_DBHorizontalPhase;DB Horizontal Phase;28;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;1498;-5348.329,4337.952;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;749;-5383.727,2626.877;Float;False;Property;_DBVerticalAmplitude;DB Vertical Amplitude;20;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1288;-5383.727,2722.876;Float;False;Property;_DBVerticalAmplitudeOffset;DB Vertical Amplitude Offset;21;0;Create;True;0;0;0;False;0;False;1.2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1249;-5383.727,3426.877;Float;False;Property;_DBHorizontalMaxRadius;DB Horizontal Max Radius;29;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;792;-5383.727,3010.877;Float;False;Property;_DBVerticalMaxLength;DB Vertical Max Length;24;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1301;-5383.727,2914.877;Float;False;Property;_DBVerticalPhase;DB Vertical Phase;23;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;780;-5383.727,2819.877;Float;False;Property;_DBVerticalFrequency;DB Vertical Frequency;22;0;Create;True;0;0;0;False;0;False;1.15;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1218;-5383.727,3233.877;Float;False;Property;_DBHorizontalFrequency;DB Horizontal Frequency;27;0;Create;True;0;0;0;False;0;False;1.16;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1220;-5383.727,3138.877;Float;False;Property;_DBHorizontalAmplitude;DB Horizontal Amplitude;26;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1504;-5820.254,1775.649;Inherit;True;Property;_NoiseTexture;Noise Texture;6;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;1519;-6222.556,3363.691;Inherit;False;Property;_MBWindDirBlend;MB Wind Dir Blend;15;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1520;-6220.556,3283.691;Inherit;False;Global;MBGlobalWindDir;MB Global Wind Dir;28;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;1506;-5814.558,2157.492;Float;False;Property;_NoisePannerSpeed;Noise Panner Speed;8;0;Create;True;0;0;0;False;0;False;0.1,0.1;0.08,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;850;-6216.192,3198.146;Float;False;Property;_MBWindDir;MB Wind Dir;16;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;1518;-5888.433,1976.041;Inherit;False;Property;_NoiseTextureTilling;Noise Tilling - Static (XY), Animated (ZW);7;0;Create;False;0;0;0;False;0;False;1,1,1,1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1262;-6228.192,2815.146;Float;False;Property;_MBAmplitudeOffset;MB Amplitude Offset;11;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;480;-6221.192,2910.146;Float;False;Property;_MBFrequency;MB Frequency;12;0;Create;True;0;0;0;False;0;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1286;-6214.192,3096.146;Float;False;Property;_MBPhase;MB Phase;14;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1334;-6222.192,3566.146;Inherit;False;Property;_MBMaxHeight;MB Max Height;18;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;952;-6222.482,3461.336;Float;False;Property;_MBWindDirOffset;MB Wind Dir Offset;17;0;Create;True;0;0;0;False;0;False;20;0;0;180;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1482;-6221.055,3006.571;Inherit;False;Property;_MBFrequencyOffset;MB Frequency Offset;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;300;-6221.192,2722.146;Float;False;Property;_MBAmplitude;MB Amplitude;10;0;Create;True;0;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1511;-5510.461,1859.439;Inherit;False;WorldSpaceNoise - NHP;-1;;90;af5fa9ff24e18344ebcc05b64d296c57;0;4;22;FLOAT2;0,0;False;20;SAMPLER2D;;False;24;FLOAT4;1,1,1,1;False;19;FLOAT2;0.1,0.1;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.RangedFloatNode;687;-6221.192,2627.146;Float;False;Property;_MBDefaultBending;MB Default Bending;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;1215;-3206.568,2945.181;Float;False;Constant;_Vector2;Vector 2;27;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;959;-3209.762,2686.052;Float;False;Constant;_Vector0;Vector 0;27;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TexturePropertyNode;1458;-3873.645,1809.417;Float;True;Property;_PatternTex;Pattern Texture;5;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;None;50e8be33b1640034bbc8e6dacf43c1ee;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;1454;-5527.684,4639.243;Inherit;False;Constant;_Float2;Float 2;26;0;Create;True;0;0;0;False;0;False;-1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;960;-2977.889,2753.048;Float;False;Property;_EnableVerticalBending;Enable Vertical Bending;19;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;515;-3643.76,1209.741;Float;True;Property;_MainTex;Main Texture;4;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;1488;-1433.304,3008.29;Inherit;False;RotationAngle - NHP;-1;;91;87b0b7c0fc8f1424db43b84d20c2e79b;0;9;36;FLOAT;0;False;35;FLOAT;0;False;34;FLOAT;1;False;28;FLOAT;1;False;47;FLOAT;0;False;29;FLOAT;1;False;46;FLOAT;0;False;42;FLOAT;0;False;27;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1486;-1433.083,2507.412;Inherit;False;RotationAxis - NHP;-1;;92;b90648f17dcc4bc449d46e8cf04564ff;0;3;20;FLOAT;0;False;19;FLOAT;0;False;18;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;1465;-3230.339,1631.972;Inherit;False;Property;_PatternColor1;Pattern Color 1;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1466;-3229.366,1455.992;Inherit;False;Property;_PatternColor2;Pattern Color 2;3;0;Create;True;0;0;0;False;0;False;0,0,0,1;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1490;-462.7808,2757.542;Inherit;False;MainBending - NHP;-1;;93;01dba1f3bc33e4b4fa301d2180819576;0;4;55;FLOAT3;0,0,0;False;53;FLOAT;0;False;59;FLOAT3;0,0,0;False;58;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1517;705.0869,2935.281;Inherit;False;Property;_Smoothness;Smoothness;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1516;705.0869,2848.281;Inherit;False;Property;_Metallic;Metallic;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1009.964,2756.547;Float;False;True;-1;2;LowPolyTreeWithPatterns_MaterialInspector;0;0;Standard;Nicrom/NHP/ASE/Low Poly Tree With Patterns;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;1;Pragma;multi_compile_instancing;False;;Custom;False;0;0;;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=CEF95DFAC53B586B2969E3AB3D5C8BB7CEEEFD2C