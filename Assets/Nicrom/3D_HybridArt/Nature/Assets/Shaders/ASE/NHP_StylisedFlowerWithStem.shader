...
Shader "Nicrom/NHP/ASE/Stylised Flower With Stem"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 objToWorld11_g99 = mul( unity_ObjectToWorld, float4( LocalPivot1504, 1 ) ).xyz;
			...
			float3 worldToObj35_g130 = mul( unity_WorldToObject, float4( appendResult14_g130, 1 ) ).xyz;
			float3 worldToObj36_g130 = mul( unity_WorldToObject, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 objToWorld52_g129 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float MB_RotationAngle97 = radians( ( ( ( ( MB_Amplitude880 + ( MB_AmplitudeOffset1356 * (StaticWorldNoise31_g129).x ) ) * sin( ( ( ( objToWorld52_g129.x + objToWorld52_g129.z ) + ( ( _Time.y * ( MB_Frequency873 + ( MB_FrequencyOffset1525 * (StaticWorldNoise31_g129).x ) ) ) + ( ( 2.0 * UNITY_PI ) * DB_PhaseShift928 ) ) ) * MB_Phase1360 ) ) ) + MB_DefaultBending877 ) * ( ase_vertex3Pos.y / MB_MaxHeight1335 ) ) );
			...
			float3 objToWorld53_g115 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 objToWorld98_g158 = mul( unity_ObjectToWorld, float4( appendResult15_g158, 1 ) ).xyz;
			float3 objToWorld102_g158 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 objToWorld100_g158 = mul( unity_ObjectToWorld, float4( appendResult3_g158, 1 ) ).xyz;
			float3 objToWorld106_g158 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float NaNPrevention21_g158 = step( 0.01 , abs( ( temp_output_12_0_g158 * ( 180.0 / UNITY_PI ) ) ) );
			float3 lerpResult26_g158 = lerp( float3(1,0,0) , appendResult24_g158 , NaNPrevention21_g158);
			float3 worldToObj99_g158 = mul( unity_WorldToObject, float4( lerpResult26_g158, 1 ) ).xyz;
			float3 worldToObj105_g158 = mul( unity_WorldToObject, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 rotatedValue35_g158 = RotateAroundAxis( LocalPivot1504, ( ase_vertex3Pos + MainBending89_g158 ), RotationAxis30_g158, RotationAngle29_g158 );
			float3 lerpResult52_g158 = lerp( MainBending89_g158 , ( rotatedValue35_g158 - ase_vertex3Pos ) , NaNPrevention21_g158);
...
Node;AmplifyShaderEditor.Vector2Node;1463;-309.8395,846.4044;Inherit;False;Constant;_Vector33;Vector 33;20;0;Create;True;0;0;0;False;0;False;0.5,0.5;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1505;-4807.063,2352.738;Inherit;False;Property;_ColorBlendStart;Color Blend Start;2;0;Create;True;0;0;0;False;0;False;0.1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1470;-4803.965,2453.833;Inherit;False;Property;_ColorBlendEnd;Color Blend End;3;0;Create;True;0;0;0;False;0;False;0.15;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;1815;-2824.401,2509.249;Inherit;False;Property;_NoiseTextureTilling;Noise Tilling - Static (XY), Animated (ZW);27;0;Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;1814;-2754.401,2682.25;Float;False;Property;_NoisePannerSpeed;Noise Panner Speed;28;0;Create;True;0;0;0;False;0;False;0.05,0.03;0.08,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;1810;-4809.595,3300.19;Inherit;False;Property;_MBWindDirBlend;MB Wind Dir Blend;16;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1308;-4030.775,2579.569;Float;False;Property;_DBHorizontalPhase;DB Horizontal Phase;21;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1538;-2755.761,2310.993;Inherit;True;Property;_NoiseTexture;Noise Texture;26;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1218;-4032.775,2483.569;Float;False;Property;_DBHorizontalFrequency;DB Horizontal Frequency;20;0;Create;True;0;0;0;False;0;False;1.16;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1809;-4807.595,3212.19;Inherit;False;Global;MBGlobalWindDir;MB Global Wind Dir;28;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;850;-4810.689,3122.742;Float;False;Property;_MBWindDir;MB Wind Dir;14;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1249;-4032.775,2675.569;Float;False;Property;_DBHorizontalMaxRadius;DB Horizontal Max Radius;22;0;Create;True;0;0;0;False;0;False;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1220;-4032.775,2386.569;Float;False;Property;_DBHorizontalAmplitude;DB Horizontal Amplitude;19;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1524;-4811.99,2929.007;Inherit;False;Property;_MBFrequencyOffset;MB Frequency Offset;12;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;480;-4814.087,2834.873;Float;False;Property;_MBFrequency;MB Frequency;11;0;Create;True;0;0;0;False;0;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;952;-4805.979,3394.934;Float;False;Property;_MBWindDirOffset;MB Wind Dir Offset;15;0;Create;True;0;0;0;False;0;False;20;0;0;180;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;687;-4814.087,2546.874;Float;False;Property;_MBDefaultBending;MB Default Bending;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1334;-4808.824,3517.175;Inherit;False;Property;_MBMaxHeight;MB Max Height;17;0;Create;True;0;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1286;-4810.689,3025.742;Float;False;Property;_MBPhase;MB Phase;13;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1262;-4814.087,2738.873;Float;False;Property;_MBAmplitudeOffset;MB Amplitude Offset;10;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;300;-4814.087,2642.873;Float;False;Property;_MBAmplitude;MB Amplitude;9;0;Create;True;0;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1068;-1405.837,2435.614;Inherit;False;2939.069;1275.755;;27;1045;1781;1807;1779;1806;1780;1533;1415;1421;1413;1507;1420;97;1785;1786;1366;1370;1512;1375;1367;1369;1376;1362;1378;1526;1365;1371;Main Bending;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1455;-2317.697,4212.805;Inherit;False;Constant;_Float2;Float 2;26;0;Create;True;0;0;0;False;0;False;1.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;1215;-2494.941,3184.301;Float;False;Constant;_Vector2;Vector 2;27;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;1477;521.9259,892.152;Inherit;False;Property;_FlowerColor1;Flower Color 1;0;0;Create;True;0;0;0;False;0;False;0.7843137,0.454902,0.1411765,1;0.5754717,0.3435538,0.1465824,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1476;551.7269,1072.368;Inherit;False;Property;_FlowerColor2;Flower Color 2;1;0;Create;True;0;0;0;False;0;False;0.8980392,0.9529412,1,1;0.009433985,0.4014694,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1804;-4034.173,2886.452;Inherit;False;Property;_SlopeCorrectionOffset;Slope Correction Offset;25;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1774;-4030.819,2787.221;Inherit;False;Property;_SlopeCorrectionMagnitude;Slope Correction Magnitude;24;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1479;790.1998,1326.214;Float;False;Property;_StemColor;Stem Color;4;0;Create;True;0;0;0;False;0;False;0.3960784,0.5647059,0.1019608,1;0.8301887,0.5461104,0.3015307,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;1781;936.2124,2848.605;Float;False;Property;_EnableSlopeCorrection;Enable Slope Correction;23;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;1265;1923.979,2049.843;Inherit;False;631.4954;512.0168;;5;0;1508;296;1574;1816;Master Node;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1534;-3836.964,3010.247;Inherit;False;Property;_AlphaCutoff;Alpha Cutoff;7;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1508;2068.027,2295.639;Inherit;False;1494;Opacity;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2291.679,2118.861;Float;False;True;-1;2;StylisedFlowerWithStem_MaterialInspector;0;0;Standard;Nicrom/NHP/ASE/Stylised Flower With Stem;False;False;False;False;False;False;True;False;False;False;False;False;True;False;False;False;False;False;False;False;False;Off;0;False;;0;False;;False;0;False;;0;False;;False;0;Custom;0.5;True;True;0;True;Opaque;;AlphaTest;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;True;_AlphaCutoff;1;Pragma;multi_compile_instancing;False;;Custom;False;0;0;;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.FunctionNode;1855;507.5047,3057.542;Inherit;False;SlopeCorrection - NHP;-1;;158;af38de3ca0adf3c4ba9b6a3dd482959e;0;5;87;FLOAT3;0,0,0;False;42;FLOAT;1;False;92;FLOAT;0;False;93;FLOAT4;0,0,0,0;False;41;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1574;2026.197,2426.878;Inherit;False;1045;LocalVertexOffset;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;1816;2091.049,2201.133;Inherit;False;Constant;_Float3;Float 3;30;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;296;2065.489,2106.808;Inherit;False;1493;Albedo;1;0;OBJECT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=CEC4A308B977620BE5530E4C5DD5FC9369626037