...
Shader "Nicrom/NHP/ASE/Low Poly Lily Pad"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 objToWorld11_g63 = mul( unity_ObjectToWorld, float4( Pivot1504, 1 ) ).xyz;
			...
			float3 objToWorld1706 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 worldToObj35_g91 = mul( unity_WorldToObject, float4( appendResult14_g91, 1 ) ).xyz;
			float3 worldToObj36_g91 = mul( unity_WorldToObject, float4( float3( 0,0,0 ), 1 ) ).xyz;
			...
			float3 HorizontalMovement1680 = ( ( ( ( HorizontalAmplitude880 + ( VerticalAmplitudeOffset1356 * (StaticNoise1340).r ) ) * sin( ( ( ( objToWorld1706.x + objToWorld1706.z ) + ( ( _Time.y * ( HorizontalFrequency873 + ( HorizontalFrequencyOffset1525 * (StaticNoise1340).g ) ) ) + ( ( 2.0 * UNITY_PI ) * DB_PhaseShift928 ) ) ) * HorizontalPhase1360 ) ) ) * Direction1420 ) * step( -0.1 , ase_vertex3Pos.y ) );
...
Node;AmplifyShaderEditor.Vector4Node;1697;-5818.059,2506.741;Inherit;False;Property;_NoiseTextureTilling;Noise Tilling - Static (XY), Animated (ZW);18;0;Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;1538;-5749.85,2306.892;Inherit;True;Property;_NoiseTexture;Noise Texture;17;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;1698;-5753.059,2679.742;Float;False;Property;_NoisePannerSpeed;Noise Panner Speed;19;0;Create;True;0;0;0;False;0;False;0.05,0.03;0.08,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1685;-5277.209,3441.665;Inherit;False;Property;_RotationFrequencyOffset;Rotation Frequency Offset;15;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1218;-5274.93,3337.358;Float;False;Property;_RotationFrequency;Rotation Frequency;14;0;Create;True;0;0;0;False;0;False;1.16;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1524;-6071.786,3418.967;Inherit;False;Property;_HorizontalFrequencyOffset;Horizontal Frequency Offset;6;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;480;-6075.884,3320.834;Float;False;Property;_HorizontalFrequency;Horizontal Frequency;5;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1308;-5275.93,3541.358;Float;False;Property;_RotationPhase;Rotation Phase;16;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1683;-5273.209,3231.665;Inherit;False;Property;_RotationAmplitudeOffset;Rotation Amplitude Offset;13;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1701;-6074.14,3688.748;Inherit;False;Global;GlobalWindDir;Global Wind Dir;28;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1220;-5272.285,3130.368;Float;False;Property;_RotationAmplitude;Rotation Amplitude;12;0;Create;True;0;0;0;False;0;False;8;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;850;-6074.486,3609.703;Float;False;Property;_HorizontalWindDir;Horizontal Wind Dir;8;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1702;-6073.14,3768.748;Inherit;False;Property;_HorizontalWindDirBlend;Horizontal Wind Dir Blend;10;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1262;-6074.884,3224.834;Float;False;Property;_HorizontalAmplitudeOffset;Horizontal Amplitude Offset;4;0;Create;True;0;0;0;False;0;False;0.04;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1286;-6072.486,3510.703;Float;False;Property;_HorizontalPhase;Horizontal Phase;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;952;-6071.293,3858.168;Float;False;Property;_HorizontalWindDirOffset;Horizontal Wind Dir Offset;9;0;Create;True;0;0;0;False;0;False;20;0;0;180;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;300;-6074.884,3130.834;Float;False;Property;_HorizontalAmplitude;Horizontal Amplitude;3;0;Create;True;0;0;0;False;0;False;0.05;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;1643;-2124.211,2919.361;Float;False;Constant;_Vector0;Vector 0;25;0;Create;True;0;0;0;False;0;False;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;1568;-1726.948,2088.865;Float;False;Constant;_Float11;Float 11;8;0;Create;True;0;0;0;False;0;False;-0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;1677;-1544.532,2982.859;Float;False;Constant;_Vector2;Vector 2;27;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;1699;662.9905,1976.196;Inherit;False;Property;_Metallic;Metallic;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1700;662.9905,2063.196;Inherit;False;Property;_Smoothness;Smoothness;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;1330;-19002.03,10716.32;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1004.352,1928.737;Float;False;True;-1;2;LowPolyLilyPad_MaterialInspector;0;0;Standard;Nicrom/NHP/ASE/Low Poly Lily Pad;False;False;False;False;False;False;True;False;False;False;False;False;False;False;False;False;False;True;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;True;;1;Pragma;multi_compile_instancing;False;;Custom;False;0;0;;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.TransformPositionNode;1705;-3769.882,3330.324;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TransformPositionNode;1706;-2752.983,1717.596;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=B7DE1AB13B678C6C2809B51F2A06EB55D9011DFF